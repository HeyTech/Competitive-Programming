  ...
  if (l1_vertical) {
      ...
      if(l1y0 > l2y0 && l1y0 < l2y1){
          if(l2x0 > l1x0 && l2x0 < l1x1 ){
              std::cout << "Intersection found: \t Line 1: " << l1 << " Line 2: " <<  l2 << " -> x: " << l2x0 << " y: " << l1y0 << std::endl;
...
void day3::find_junctions(){
  for(std::uint32_t w1{0}; w1 < wire2_lines.size(); w1++){
      for(std::uint32_t w2{0}; w2 < wire1_lines.size(); w2++){
          check_junctions(wire2_lines[w1], wire2_lines[w2]);
        }
    }
}
...
void day3::task1(){
  std::cout << "Welcome to day 3 task 1" << std::endl;
  ...
  for(std::uint32_t i{0}; i < wire1.size(); i++){
      ...
      //      std::cout << current_point1 << " \t" << next_point << " \twire1_lines size: " << wire1_lines.size() <<  std::endl;
  ...
  for(std::uint32_t i{0}; i < wire2.size(); i++){
      ...
      //      std::cout << current_point2 << " \t" << next_point << " \twire2_lines size: " << wire2_lines.size() <<  std::endl;
      current_point = next_point;
    }
...
void day3::task2(){
  std::cout << "Welcome to day 3 task 2" << std::endl;
